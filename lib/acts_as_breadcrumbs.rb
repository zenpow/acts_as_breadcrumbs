    ...
    module Breadcrumbs
      ...
      module ClassMethods
        ...
        def acts_as_breadcrumbs(options = {})
          ...
          breadcrumbs_self_basename = options.delete(:self_basename) || breadcrumbs_basename
          ...
          # Output dynamic breadcrumbs, use model's attributes
          dynamic_breadcrumbs = "
            def breadcrumbs
          ...
          self.class_eval(dynamic_breadcrumbs)
